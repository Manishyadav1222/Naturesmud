...
let festivalOffers: any[] = [
  ...
  },
  {
    ...
    subtitle: 'Mix Dry Nuts, Chia Seeds & Himalayan Pink Salt',
    ...
    items: [
      ...
      { productId: '18', name: 'Raw Almond (200 GM)', weight: '200 GM', image: '/products/almonds.jpg', price: 568 },
    ],
    highlights: [
      'High Plant Protein & Minerals for Fast Recovery',
      'Hydration Support with Clean Pink Salt Trace Minerals',
      'Clean Pre/Post-Workout Fuel with Zero Cane Sugar',
    ],
    isFestival: false,
    isActive: true,
  },
  {
    ...
    subtitle: 'Dates Powder, Chia Seeds & Himalayan Pink Salt',
  ...
  },
  {
    ...
    themeColor: 'purple',
    items: [
      { productId: '25', name: 'Sweet Potato Powder (150 GM)', weight: '150 GM', image: '/products/sweet-potato-powder-100g.jpg', price: 510 },
      { productId: '8', name: 'Dates Powder (100 GM)', weight: '100 GM', image: '/products/dates-powder-100g.jpg', price: 380 },
    ],
    highlights: [
