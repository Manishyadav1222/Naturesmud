...
export const products: Product[] = [
  {
    ...
    badges: ['bestseller', 'organic', 'raw'],
    ingredients: ['100% Raw Wild Himalayan Multi-floral Honey'],
    benefits: [
    ...
    nutrition: [
      ...
      { label: 'Sugars', value: '82.1g' },
      { label: 'Protein', value: '0.3g' },
      { label: 'Fat', value: '0g' },
      { label: 'Fiber', value: '0.2g' },
      { label: 'Vitamin C', value: '0.5mg' },
      { label: 'Calcium', value: '6mg' },
      { label: 'Iron', value: '0.4mg' },
    ],
    ...
    isBestSeller: true,
    isNew: false,
    tags: ['honey', 'wild', 'himalayan', 'raw', 'organic', 'immunity', 'gift'],
  ...
  },
  {
    ...
    isBestSeller: false,
    isNew: false,
    tags: ['honey', 'wild', 'himalayan', 'raw', 'organic', 'starter'],
  ...
  },
  {
    ...
    badges: ['bestseller', 'superfood', 'lab-tested'],
    ingredients: ['100% Purified Himalayan Shilajit Resin (Asphaltum punjabianum)'],
    benefits: [
    ...
    nutrition: [
      ...
      { label: 'Humic Acid', value: '12%+' },
      { label: 'Trace Minerals', value: '85+' },
      { label: 'Iron', value: 'High' },
      { label: 'Magnesium', value: 'High' },
      { label: 'Zinc', value: 'Moderate' },
      { label: 'Selenium', value: 'Present' },
    ],
    ...
    isBestSeller: true,
    isNew: false,
    tags: ['shilajit', 'resin', 'fulvic-acid', 'energy', 'testosterone', 'adaptogen', 'superfood'],
  ...
  },
  {
    ...
    isBestSeller: false,
    isNew: false,
    tags: ['shilajit', 'resin', 'starter', 'fulvic-acid'],
  ...
  },
  {
    ...
    nutrition: [
      ...
      { label: 'Fiber', value: '19g' },
      { label: 'Iron', value: '28mg (156% DV)' },
      { label: 'Calcium', value: '1850mg (142% DV)' },
      { label: 'Vitamin A', value: '378% DV' },
      { label: 'Vitamin C', value: '17mg (19% DV)' },
      { label: 'Potassium', value: '1324mg' },
    ],
    ...
    isBestSeller: true,
    isNew: false,
    tags: ['moringa', 'superfood', 'powder', 'protein', 'iron', 'organic', 'vegan'],
  ...
  },
  {
    ...
    categorySlug: 'superfoods',
    badges: ['organic', 'superfood'],
    ingredients: ['100% Organic Black Chia Seeds (Salvia hispanica)'],
    benefits: [
    ...
    nutrition: [
      { label: 'Omega-3 (ALA)', value: '17.8g' },
      { label: 'Fiber', value: '34.4g' },
      { label: 'Protein', value: '16.5g' },
      { label: 'Calcium', value: '631mg (49% DV)' },
      { label: 'Iron', value: '7.7mg (43% DV)' },
      { label: 'Magnesium', value: '335mg (80% DV)' },
    ],
    ...
    isBestSeller: false,
    isNew: false,
    tags: ['chia', 'seeds', 'omega3', 'fiber', 'protein', 'organic', 'vegan', 'keto'],
  ...
  },
  {
    ...
    badges: ['organic', 'new'],
    ingredients: ['100% Organic Deglet Noor Dates Powder'],
    benefits: [
    ...
    isBestSeller: true,
    isNew: true,
    tags: ['dates', 'powder', 'sweetener', 'sugar-free', 'low-gi', 'baking', 'organic', 'vegan'],
  ...
  },
  {
    ...
    isBestSeller: true,
    isNew: true,
    tags: ['baby', 'massage', 'oil', 'organic', 'pediatrician-approved', 'newborn', 'gift'],
  ...
  },
  {
    ...
    nutrition: [
      { label: 'Calories', value: '<5 kcal per cup' },
    ...
    isBestSeller: false,
    isNew: false,
    tags: ['tea', 'herbal', 'immunity', 'tulsi', 'guduchi', 'turmeric', 'caffeine-free', 'ayurvedic'],
  ...
  },
  {
    ...
    description: 'Curated 4-product combo to start your day the Himalayan way. Includes: Wild Himalayan Honey 250g, Organic Turmeric Latte Mix 100g, Organic Amla Powder 100g, and Himalayan Green Tea 50g. Save 19% vs buying individually. Perfect gift for wellness enthusiasts or your own morning upgrade.',
    shortDescription: '4-product morning wellness bundle. Honey, turmeric latte, amla, green tea. Save 19%.',
    price: 3999,
    compareAtPrice: 4949,
    ...
    isBestSeller: true,
    isNew: true,
    tags: ['bundle', 'morning', 'ritual', 'wellness', 'gift', 'immunity', 'energy', 'starter'],
  ...
  },
  {
    ...
    badges: ['organic'],
    ingredients: ['100% Raw Himalayan Walnut Kernels (Juglans regia)'],
    benefits: [
    ...
    nutrition: [
      ...
      { label: 'Protein', value: '15.2g' },
      { label: 'Fat', value: '65.2g' },
      { label: 'Fiber', value: '6.7g' },
      { label: 'Magnesium', value: '158mg' },
      { label: 'Vitamin E', value: '0.7mg' },
    ],
    ...
    isBestSeller: false,
    isNew: false,
    tags: ['walnuts', 'nuts', 'omega3', 'brain-health', 'organic', 'wild-grown', 'keto'],
  ...
  },
  {
    ...
    nutrition: [
      ...
      { label: 'Iron', value: '28.5mg (158% DV)' },
      { label: 'Vitamin B12', value: '120µg (5000% DV)' },
      { label: 'Phycocyanin', value: '12-15%' },
      { label: 'Chlorophyll', value: '1.1%' },
      { label: 'GLA (Omega-6)', value: '1.3g' },
    ],
    ...
    isBestSeller: false,
    isNew: false,
    tags: ['spirulina', 'blue-green-algae', 'protein', 'b12', 'iron', 'vegan', 'detox', 'superfood'],
    createdAt: '2024-02-20T10:00:00Z',
    updatedAt: '2024-11-20T10:00:00Z',
  },
];

// Normalize product data (add computed fields, ensure consistency)
export function normalizeProduct(raw: any): Product {
  const categoryName =
    typeof raw.category === 'object' && raw.category !== null
      ? (raw.category.name || 'Organic')
  ...
  const categorySlug =
    typeof raw.category === 'object' && raw.category !== null
      ? (raw.category.slug || raw.categorySlug || 'organic')
      : raw.categorySlug ||
