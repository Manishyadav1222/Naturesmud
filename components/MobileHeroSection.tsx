...
export const MOBILE_POSTERS: MobileHeroPoster[] = [
  {
    ...
    originalPrice: 430,
    weight: '100g',
    badge: "Earth's Ritual",
    primary: '#9F1239',
    secondary: '#881337',
    accent: '#E11D48',
    bgTint: 'rgba(159, 18, 57, 0.08)',
    overlayFrom: 'rgba(159,18,57,0.30)',
    overlayTo: 'rgba(50,5,20,0.85)',
  },
  {
    id: 'beetroot-ad1',
    name: 'Beetroot Powder',
    subname: 'Premium Red Beetroot – Boost Stamina & Glow',
    slug: 'beetroot-powder',
    image: '/products/nm-beetroot-ad1.jpeg',
    price: 430,
    originalPrice: 430,
    weight: '100g',
    badge: 'Nitric Oxide Boost',
    primary: '#BE123C',
    secondary: '#9F1239',
    accent: '#FB7185',
    bgTint: 'rgba(190, 18, 60, 0.08)',
    overlayFrom: 'rgba(190,18,60,0.30)',
    overlayTo: 'rgba(60,5,20,0.85)',
  },
  {
    id: 'beetroot-ad2',
    name: 'Beetroot Powder',
    subname: 'Sun-Kissed Himalayan Beets – Pure Energy',
    slug: 'beetroot-powder',
    image: '/products/nm-beetroot-ad2.jpeg',
    price: 430,
    originalPrice: 430,
    weight: '100g',
    badge: 'Iron Rich',
    ...
    overlayFrom: 'rgba(153,27,27,0.30)',
    overlayTo: 'rgba(45,5,5,0.85)',
  },
  {
    id: 'mountain-apple-crisp',
    ...
    originalPrice: 510,
    weight: '100g',
    badge: 'Mountain Crisp',
    primary: '#15803D',
    secondary: '#166534',
    accent: '#22C55E',
    bgTint: 'rgba(21, 128, 61, 0.08)',
    overlayFrom: 'rgba(21,128,61,0.30)',
    overlayTo: 'rgba(10,40,15,0.85)',
  },
  {
    id: 'apple-design',
    name: 'Dehydrated Apple',
    subname: 'Crispy Sun-Dried Apple Rings – Zero Sugar Added',
    slug: 'dehydrated-apple',
    image: '/products/nm-apple-design.jpeg',
    price: 510,
    originalPrice: 510,
    weight: '100g',
    badge: 'Fibre Rich',
    ...
    overlayFrom: 'rgba(22,101,52,0.30)',
    overlayTo: 'rgba(8,30,12,0.85)',
  },
  {
    id: 'premium-harvest-cashew',
    ...
    secondary: '#1E1B4B',
    accent: '#F59E0B',
    bgTint: 'rgba(49, 46, 129, 0.08)',
    overlayFrom: 'rgba(49,46,129,0.35)',
    overlayTo: 'rgba(10,10,35,0.88)',
  },
  {
    id: 'cashew-jar2',
    name: 'Roasted Cashews',
    subname: 'Buttery W240 Cashews – Heart Healthy & Delicious',
    slug: 'roasted-cashewnuts',
    image: '/products/nm-cashew-jar2.jpeg',
    price: 750,
    originalPrice: 750,
    weight: '150g',
    badge: 'W240 Grade',
    ...
    secondary: '#312E81',
    accent: '#FCD34D',
    bgTint: 'rgba(55, 48, 163, 0.08)',
    overlayFrom: 'rgba(55,48,163,0.35)',
    overlayTo: 'rgba(15,12,45,0.88)',
  },
  {
    id: 'ruby-cranberries-delight',
    name: 'Dried Cranberries',
    subname: 'Tangy, Sweet & Naturally Good Ruby Cranberries',
    slug: 'dried-cranberries',
    image: '/products/nm-cranberry-jar.jpeg',
    price: 415,
    originalPrice: 415,
    weight: '100g',
    badge: 'Ruby Antioxidant',
    primary: '#881337',
    secondary: '#701A75',
    accent: '#F43F5E',
    bgTint: 'rgba(136, 19, 55, 0.08)',
    overlayFrom: 'rgba(136,19,55,0.30)',
    overlayTo: 'rgba(40,5,20,0.85)',
  },
  {
    id: 'chia-power',
    name: 'Chia Seeds',
  ...
  },
  {
    id: 'chia-studio',
    name: 'Chia Seeds',
    subname: 'Pure Black Chia – 10x Hydration & Gut Health',
    slug: 'chia-seeds',
    image: '/products/nm-chia-studio.jpeg',
    price: 495,
    originalPrice: 495,
    weight: '300g',
    badge: 'Gut Health',
    ...
    secondary: '#115E59',
    accent: '#2DD4BF',
    bgTint: 'rgba(15, 118, 110, 0.08)',
    overlayFrom: 'rgba(15,118,110,0.30)',
    overlayTo: 'rgba(2,35,28,0.80)',
  },
  {
    id: 'chia-display',
    name: 'NaturesMud Chia',
    subname: 'NaturesMud Signature Organic Chia – Glass Jar',
    slug: 'chia-seeds',
    image: '/products/nm-chia-display.jpeg',
    price: 495,
    originalPrice: 495,
    weight: '300g',
    badge: 'Premium Glass Jar',
    primary: '#134E4A',
    secondary: '#0F3D38',
    accent: '#34D399',
    bgTint: 'rgba(19, 78, 74, 0.08)',
    overlayFrom: 'rgba(19,78,74,0.30)',
    overlayTo: 'rgba(4,22,20,0.80)',
  },
  {
    id: 'chia-ad',
    name: 'Chia Power',
    subname: 'Science-Backed Superfood for Daily Wellness',
    slug: 'chia-seeds',
    image: '/products/nm-chia-ad.jpeg',
    price: 495,
    originalPrice: 495,
    weight: '300g',
    ...
    secondary: '#064E3B',
    accent: '#6EE7B7',
    bgTint: 'rgba(6, 95, 70, 0.08)',
    overlayFrom: 'rgba(6,95,70,0.30)',
    overlayTo: 'rgba(2,25,15,0.80)',
  },
  {
  ...
  },
  {
    id: 'blueberry-purple',
    name: 'Dried Blueberries',
    subname: 'Wild Berry Burst – Brain & Vision Support',
    slug: 'dried-blueberries',
    image: '/products/nm-blueberry-purple.jpeg',
    price: 650,
    originalPrice: 650,
    weight: '100g',
    badge: 'Brain Booster',
    ...
    overlayFrom: 'rgba(79,70,229,0.30)',
    overlayTo: 'rgba(12,8,45,0.80)',
  },
  {
    id: 'blueberry-shoot',
    name: 'Dried Blueberries',
    subname: 'Premium Himalayan Blueberries – 0 Added Sugar',
    slug: 'dried-blueberries',
    image: '/products/nm-blueberry-shoot.jpeg',
    price: 650,
    originalPrice: 650,
    weight: '100g',
    badge: '0 Added Sugar',
    ...
    secondary: '#4C1D95',
    accent: '#C4B5FD',
    bgTint: 'rgba(91, 33, 182, 0.08)',
    overlayFrom: 'rgba(91,33,182,0.30)',
    overlayTo: 'rgba(18,5,45,0.80)',
  },
  {
    id: 'papaya-splash',
  ...
  },
  {
    ...
    secondary: '#78350F',
    accent: '#FCD34D',
    bgTint: 'rgba(146, 64, 14, 0.08)',
    overlayFrom: 'rgba(146,64,14,0.30)',
    overlayTo: 'rgba(40,15,0,0.85)',
  },
  {
    id: 'carrot-powder',
    name: 'Carrot Powder',
    ...
    overlayFrom: 'rgba(194,65,12,0.30)',
    overlayTo: 'rgba(50,12,2,0.85)',
  },
  {
    id: 'dates-powder',
    name: 'Dates Powder',
    subname: 'Natural Sweetener – Iron & Fibre Packed',
    slug: 'dates-powder',
    ...
    bgTint: 'rgba(146, 64, 14, 0.08)',
    overlayFrom: 'rgba(146,64,14,0.30)',
    overlayTo: 'rgba(40,12,0,0.85)',
  },
  {
    id: 'makhana-fox-nuts',
    name: 'Makhana (Fox Nuts)',
    subname: 'Himalayan Fox Nuts – Calcium & Protein Packed',
    ...
    secondary: '#713F12',
    accent: '#FDE047',
    bgTint: 'rgba(133, 77, 14, 0.08)',
    overlayFrom: 'rgba(133,77,14,0.30)',
    overlayTo: 'rgba(38,18,0,0.85)',
  },
  {
    id: 'himalayan-pink-salt',
    name: 'Himalayan Pink Salt',
    subname: 'Ancient Crystal Salt – 84 Trace Minerals',
    ...
    accent: '#FDA4AF',
    bgTint: 'rgba(190, 24, 93, 0.08)',
    overlayFrom: 'rgba(190,24,93,0.25)',
    overlayTo: 'rgba(50,5,25,0.80)',
  },
  {
    id: 'shilajit-resin',
    name: 'Shilajit Resin',
    subname: 'Pure Himalayan Shilajit – Fulvic Acid & Energy',
    slug: 'shilajit',
    image: '/products/nm-shilajit-jar.jpeg',
    price: 1200,
    originalPrice: 1400,
    weight: '30g',
    badge: 'Himalayan Gold',
    primary: '#1C1917',
    secondary: '#0C0A09',
    accent: '#D97706',
    bgTint: 'rgba(28, 25, 23, 0.08)',
    overlayFrom: 'rgba(28,25,23,0.40)',
    overlayTo: 'rgba(8,6,4,0.90)',
  },
  {
    id: 'dehydrated-mango',
    name: 'Dehydrated Mango',
    subname: 'Sun-Dried Alphonso Mango – No Added Sugar',
    ...
    overlayFrom: 'rgba(180,83,9,0.30)',
    overlayTo: 'rgba(45,18,0,0.85)',
  },
  {
    id: 'mango-product',
    name: 'NaturesMud Mango',
    subname: 'NaturesMud Premium Dehydrated Mango',
    slug: 'dehydrated-mango',
    image: '/products/nm-mango-prod.jpeg',
    price: 480,
    originalPrice: 480,
    weight: '100g',
    ...
    overlayTo: 'rgba(55,22,0,0.85)',
  },
  {
    id: 'dehydrated-pineapple',
    name: 'Dehydrated Pineapple',
    subname: 'Tropical Pineapple Rings – Enzyme Rich',
    slug: 'dehydrated-pineapple',
    image: '/products/nm-pineapple-pouch.jpeg',
    price: 430,
    originalPrice: 430,
    weight: '100g',
    badge: 'Bromelain Rich',
    primary: '#A16207',
    secondary: '#854D0E',
    accent: '#FDE047',
    bgTint: 'rgba(161, 98, 7, 0.08)',
    overlayFrom: 'rgba(161,98,7,0.30)',
    overlayTo: 'rgba(40,20,0,0.85)',
  },
  {
    id: 'pineapple-design',
    name: 'Dehydrated Pineapple',
    subname: 'Sun-Kissed Pineapple – Digestive Support',
    slug: 'dehydrated-pineapple',
    ...
    overlayFrom: 'rgba(202,138,4,0.30)',
    overlayTo: 'rgba(50,25,0,0.85)',
  },
  {
    id: 'pure-pumpkin-seeds',
    name: 'Pumpkin Seeds',
              ...
              {MOBILE_POSTERS.map((poster, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute bottom-3 left-3 right-3 p-3.5 rounded-2xl bg-black/75 backdrop-blur-md border border-white/20 text-left z-10 space-y-2.5">
                      <div className="flex items-start justify-between gap-2.5">
                        <div className="min-w-0 flex-1">
                          <h3 className="text-lg sm:text-xl font-heading font-black tracking-tight text-[#FAF7F2] drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] leading-tight">
                            {poster.name}
                          </h3>
                        ...
                        <div className="flex flex-col items-end flex-shrink-0">
                          <div className="inline-flex items-baseline gap-1 px-3 py-1 rounded-2xl bg-white/95 backdrop-blur-md border border-white/90 shadow-[0_4px_16px_rgba(0,0,0,0.35)]">
                            <span className="text-[10px] sm:text-[11px] font-extrabold font-sans uppercase tracking-wider text-stone-600">
                              Rs.
                            </span>
                            <span
                              className="text-lg sm:text-xl font-sans font-black tracking-tight tabular-nums"
                              style={{ color: poster.primary }}
                            >
                              {poster.price}
                            </span>
                          </div>
                          {poster.originalPrice && poster.originalPrice > poster.price && (
                            <div className="text-[10px] text-white/70 line-through font-semibold font-sans mt-0.5 mr-1">
                              Rs. {poster.originalPrice}
                            </div>
                          )}
                        </div>
                      </div>
                        ...
                        >
                          {addedItem === poster.id ? (
                            ...
                            <>
                              ...
                              <span>Quick Add · <strong className="font-black text-amber-200">Rs. {poster.price}</strong></span>
                            </>
                          )}
                        </button>
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute bottom-3 left-3 right-3 p-3.5 rounded-2xl bg-black/75 backdrop-blur-md border border-white/20 text-left z-10 space-y-2.5">
                    <div className="flex items-start justify-between gap-2.5">
                      <div className="min-w-0 flex-1">
                        <h3 className="text-lg font-heading font-black tracking-tight text-[#FAF7F2] drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] leading-tight">
                          {poster.name}
                        </h3>
                      ...
                      <div className="flex flex-col items-end flex-shrink-0">
                        <div className="inline-flex items-baseline gap-1 px-2.5 py-1 rounded-2xl bg-white/95 backdrop-blur-md border border-white/90 shadow-[0_4px_16px_rgba(0,0,0,0.35)]">
                          <span className="text-[10px] font-extrabold font-sans uppercase tracking-wider text-stone-600">
                            Rs.
                          </span>
                          <span
                            className="text-lg font-sans font-black tracking-tight tabular-nums"
                            style={{ color: poster.primary }}
                          >
                            {poster.price}
                          </span>
