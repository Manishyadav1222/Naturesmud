...
export const HERO_SHOWCASE_PRODUCTS = [
  ...
  },
  {
    ...
    subheading: 'Keto-Friendly MCT Crunchy Flakes',
    weight: '100 GM',
    packing: 'Standup Ziplock Pouch',
    price: 495,
    compareAtPrice: 550,
    ...
    description: 'Crunchy sun-dried whole coconut flakes rich in clean MCT healthy fats, 0 added sugar, and 0 palm oil.',
    badge: 'Keto & MCT Energy',
    theme: {
      primary: '#0D9488',
      secondary: '#115E59',
      accent: '#2DD4BF',
      portalBg: 'radial-gradient(circle at 45% 45%, #99F6E4 0%, #0D9488 55%, #134E4A 100%)',
