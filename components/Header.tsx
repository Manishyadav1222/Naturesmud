          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="px-4 py-4 space-y-1.5">
                ...
                <a
                  href="https://api.whatsapp.com/send?phone=9779713888002&text=Hello%20NaturesMud%20Nepal!%20I%20would%20like%20to%20inquire%20about%20ordering%20superfoods."
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={closeMobileMenu}
                  className="w-full flex items-center justify-center gap-2 p-3 rounded-xl bg-[#25D366]/10 text-[#1E7E34] border border-[#25D366]/30 font-bold text-xs hover:bg-[#25D366]/20 transition-all cursor-pointer mt-2"
                >
                  ...
                  <span>Chat with Us on WhatsApp (+977-9713888002)</span>
                </a>
              </div>
            </motion.nav>
          )}
