...
export const POSTER_THEMES: PosterTheme[] = [
  ...
  },
  {
    ...
    accent: '#E11D48',
    headingColor: '#881337',
    btnGradient: 'linear-gradient(135deg, #9F1239 0%, #881337 100%)',
    btnShadow: 'rgba(159, 18, 57, 0.45)',
    badgeBg: 'bg-rose-50',
    badgeText: 'text-rose-900',
    badgeBorder: 'border-rose-300/60',
    pillBg: 'bg-rose-500/10 text-rose-900 border-rose-500/20',
    overlayFrom: 'rgba(159,18,57,0.45)',
